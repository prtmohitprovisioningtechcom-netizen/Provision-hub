  ...
  return (
    <div className="font-sans text-gray-100 bg-[#0a0a0a] min-h-screen selection:bg-white selection:text-black">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        {page.hero.show && (
          <section id="home" className="relative pt-32 pb-24 lg:pt-48 lg:pb-40 px-6 border-b border-white/10">
            {/* Grid background */}
        ...
        {/* About Section */}
        {page.about.show && (
          <section id="about" className="py-24 lg:py-40 px-6 border-b border-white/10 relative overflow-hidden">
        ...
        {page.why.show && page.why.items.length > 0 && (
          <section id="why-choose-us" className="py-24 lg:py-40 px-6 border-b border-white/10">
        ...
        {page.services.show && page.services.items.length > 0 && (
          <section id="services" className="py-24 lg:py-40 px-6 border-b border-white/10">
            <div className="mx-auto max-w-7xl">
        ...
        {page.products.show && page.products.items.length > 0 && (
          <section id="products" className="py-24 lg:py-40 px-6 border-b border-white/10 bg-white text-black">
            <div className="mx-auto max-w-7xl">
              <div className="mb-20">
        ...
        {page.gallery.show && page.gallery.images.length > 0 && (
          <section id="gallery" className="py-24 lg:py-40 px-6 border-b border-white/10">
            <div className="mx-auto max-w-7xl">
        ...
        {page.testimonials.show && page.testimonials.items.length > 0 && (
          <section id="testimonials" className="py-24 lg:py-40 px-6 border-b border-white/10">
            <div className="mx-auto max-w-7xl">
        ...
        {page.faq.show && page.faq.items.length > 0 && (
          <section id="faq" className="py-24 lg:py-40 px-6 border-b border-white/10">
        ...
        {/* Subscribe Section */}
        {page.subscribe.show && (
          <section id="subscribe" className="py-24 lg:py-40 px-6 border-b border-white/10 bg-white text-black">
        ...
        {page.blogs.show && page.blogs.items.length > 0 && (
          <section id="blogs" className="py-24 lg:py-40 px-6 border-b border-white/10">
            <div className="mx-auto max-w-7xl">
              <div className="mb-20">
        ...
        {/* Contact Section */}
        {page.contact.show && (
          <section id="contact" className="py-24 lg:py-40 px-6 bg-white text-black">
            <div className="mx-auto max-w-7xl">
