  ...
  return (
    <div className="font-sans text-gray-900 bg-[#f8fafc] overflow-x-hidden">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        {page.hero.show && (
          <section id="home" className="relative pt-24 pb-32 lg:pt-36 lg:pb-40 px-6 overflow-hidden">
        ...
        {page.why.show && page.why.items.length > 0 && (
          <section id="why-choose-us" className="py-24 px-6 bg-[#f8fafc]">
            <div className="mx-auto max-w-7xl">
        ...
        {page.products.show && page.products.items.length > 0 && (
          <section id="products" className="py-24 px-6 bg-gray-900 text-white">
            <div className="mx-auto max-w-7xl">
        ...
        {/* Subscribe Section */}
        {page.subscribe.show && (
          <section id="subscribe" className="py-24 px-6 bg-[#f8fafc]">
