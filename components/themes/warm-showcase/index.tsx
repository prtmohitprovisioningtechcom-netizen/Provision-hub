  ...
  return (
    <div className="font-serif text-[#4a3f35] bg-[#fffbf5] min-h-screen">
      ...
      <main className="pt-24">
        ...
        {/* About Section */}
        {page.about.show && (
          <section id="about" className="py-24 px-6 bg-white border-y border-[#f3e8d6]">
        ...
        {page.why.show && page.why.items.length > 0 && (
          <section id="why-choose-us" className="py-24 px-6 bg-[#fffbf5]">
        ...
        {page.products.show && page.products.items.length > 0 && (
          <section id="products" className="py-24 px-6 bg-[#2d241c] text-[#fffbf5]">
            <div className="mx-auto max-w-6xl">
              <div className="text-center mb-20">
        ...
        {page.gallery.show && page.gallery.images.length > 0 && (
          <section id="gallery" className="py-24 px-6 bg-white border-b border-[#f3e8d6]">
            <div className="mx-auto max-w-6xl">
        ...
        {/* Subscribe Section */}
        {page.subscribe.show && (
          <section id="subscribe" className="py-24 px-6 bg-white border-y border-[#f3e8d6]">
            <div className="mx-auto max-w-4xl text-center">
        ...
        {page.blogs.show && page.blogs.items.length > 0 && (
          <section id="blogs" className="py-24 px-6 bg-white border-y border-[#f3e8d6]">
            <div className="mx-auto max-w-6xl">
