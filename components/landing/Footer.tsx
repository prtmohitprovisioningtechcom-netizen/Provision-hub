        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              {footerConfig.linkedinLink && footerConfig.linkedinLink !== '#' && (
                <a href={footerConfig.linkedinLink} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-indigo-600 transition-colors">
