...
export const LANDING_SECTIONS = [
  {
    ...
    subtitle: 'Professional solutions you can trust.',
    buttonText: 'Enquire now',
    buttonLink: '',
    order: 0,
    items: [{ label: 'Directory', link: '/search' }],
  },
  { type: 'hero', title: 'Grow Your Business With Us', subtitle: 'Professional solutions designed around your goals.', order: 1 },
  { type: 'rating', title: 'Trusted by Our Customers', subtitle: 'Real experiences. Proven quality.', eyebrow: 'Customer rating', order: 2 },
  { type: 'about', title: 'About Us', subtitle: 'Get to know our company and what drives us.', order: 3 },
  {
    type: 'why-choose-us',
    title: 'Why Choose Us',
  ...
  { type: 'services', title: 'Our Services', subtitle: 'Solutions tailored to your needs.', order: 5 },
  { type: 'products', title: 'Our Products', subtitle: 'Explore our latest products.', order: 6 },
  { type: 'gallery', title: 'Our Work', subtitle: 'A closer look at what we create.', order: 7 },
  {
    type: 'blogs',
  ...
  { type: 'testimonials', title: 'Customer Stories', subtitle: 'What our customers say about us.', order: 9 },
  { type: 'faq', title: 'Frequently Asked Questions', subtitle: 'Helpful answers to common questions.', order: 10 },
  {
    type: 'subscribe',
  ...
  { type: 'contact', title: 'Contact Us', subtitle: 'Tell us what you need and our team will get back to you.', order: 12 },
  {
    type: 'footer',
    title: 'Let’s build something great together.',
    subtitle: 'Quality service, clear communication, and dependable support.',
    content: '',
    order: 13,
    items: [
